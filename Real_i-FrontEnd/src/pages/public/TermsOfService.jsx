    ...
    <div className="min-h-screen bg-surface-950 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-surface-50 mb-4">Terms of Service</h1>
        ...
        <div className="glass-card p-8 md:p-12 rounded-3xl border border-surface-700/50 bg-surface-900/60 prose prose-invert prose-primary max-w-none">
          ...
          <h2 className="text-2xl font-bold text-surface-50 mt-8 mb-4">1. Use of the Platform</h2>
          <p className="text-surface-300">
          ...
          <h2 className="text-2xl font-bold text-surface-50 mt-8 mb-4">2. User Content</h2>
          <p className="text-surface-300">
          ...
          <h2 className="text-2xl font-bold text-surface-50 mt-8 mb-4">3. Code of Conduct</h2>
          <p className="text-surface-300">
          ...
          <h2 className="text-2xl font-bold text-surface-50 mt-8 mb-4">4. Termination</h2>
          <p className="text-surface-300">
            We reserve the right to suspend or terminate your account at any time, for any reason, without notice or liability.
          </p>

          <h2 className="text-2xl font-bold text-surface-50 mt-8 mb-4">5. Contact</h2>
          <p className="text-surface-300">
