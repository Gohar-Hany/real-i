  ...
  return (
    <div className="space-y-8 animate-fade-in-up pb-10">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        {/* Core System Panel */}
        <div className="glass-card rounded-3xl border border-surface-700/50 shadow-2xl bg-surface-900/60 p-6 sm:p-8 relative overflow-hidden group hover:border-primary-500/30 transition-colors duration-500">
        ...
        <div className="glass-card rounded-3xl border border-surface-700/50 shadow-2xl bg-surface-900/60 p-6 sm:p-8 relative overflow-hidden group hover:border-blue-500/30 transition-colors duration-500">
